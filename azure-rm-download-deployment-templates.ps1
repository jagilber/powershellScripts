...
function main()
{
    ...
    else
    {
        ...
        write-host "invoke-webRequest `"https://raw.githubusercontent.com/jagilber/powershellScripts/master/azure-rm-create-aad-application-spn.ps1`" -outFile `"$($currentDir)\azure-rm-create-aad-application-spn.ps1`";" -ForegroundColor Cyan
