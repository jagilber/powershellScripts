...
rem arg2 optional machine name to deploy or undeploy
set configFolder=
set configFolder2k8=2k8r2-configs-all-rds
set configFolder2k12=2k12-configs-all-rds
set machine=
...
IF %operation%==start (
	...
	Echo start /wait powershell.exe -Executionpolicy unrestricted -file logman-wrapper.ps1 -action deploy -configurationFolder .\%configFolder% -rds %machine%
	start /wait powershell.exe -Executionpolicy unrestricted -file logman-wrapper.ps1 -action deploy -configurationFolder .\%configFolder% -rds %machine%
...
IF %operation%==stop (
	...
	Echo start /wait powershell.exe -Executionpolicy unrestricted -file logman-wrapper.ps1 -action undeploy -configurationFolder .\%configFolder% -rds %machine%
	start /wait powershell.exe -Executionpolicy unrestricted -file logman-wrapper.ps1 -action undeploy -configurationFolder .\%configFolder% -rds %machine%
