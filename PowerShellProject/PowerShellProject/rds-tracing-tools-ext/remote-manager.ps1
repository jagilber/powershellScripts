...
.NOTES  
   ...
   Author     : jagilber
   Version    : 160712.1 updated supporting scripts and commands
...
$global:startCommands.Add(@{"event-log-manager" = @{ 
    'useWmi' = $true; 
    'wait' = $false;
#    'command' = "powershell.exe";
#    'arguments' = "-WindowStyle Hidden -NonInteractive -Executionpolicy bypass -file event-log-manager.ps1 -enableDebugLogs -rds -eventLogNamePattern `"hyper|host|virtual`"";
    'command' = "powershell.exe";
    'arguments' = "-WindowStyle Hidden -NonInteractive -Executionpolicy bypass -file event-log-manager.ps1 -rds -eventLogNamePattern `"hyper|host|virtual`"";
    'workingDir' = "c:\windows\temp";
...
$global:stopCommands.Add(@{"event-log-manager" = @{ 
    'useWmi' = $true; 
    'wait' = $true;
    'command' = "powershell.exe";
 #   'arguments' = "-WindowStyle Hidden -NonInteractive -Executionpolicy bypass -file event-log-manager.ps1 -clearEventLogsOnGather -rds -uploadDir c:\windows\temp\events";
    'arguments' = "-WindowStyle Hidden -NonInteractive -Executionpolicy bypass -file event-log-manager.ps1 -minutes $($minutes) -rds  -eventLogNamePattern `"hyper|host|virtual`" -uploadDir c:\windows\temp\events";
    'workingDir' = "c:\windows\temp";
...
$global:stopCommands.Add(@{"event-log-manager-cleanup" = @{ 
    'useWmi' = $true; 
    'wait' = $false;
    'command' = "powershell.exe";
